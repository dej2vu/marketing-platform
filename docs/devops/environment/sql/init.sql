...
VALUES
    (1,'100001', 'weight,blacklist','默认策略'),
    (2,'100002', NULL, '非完整1概率'),
    (3,'100003', NULL, 'lock&lucky');
...
VALUES
    ...
    (13,'100003','107','增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.0400,'lock,lucky',1),
    (14,'100003','108','增加100次使用','抽奖2次后解锁',199,199,0.0099,'lock,lucky',2),
    (15,'100003','109','解锁全部模型','抽奖6次后解锁',1,1,0.0001,'lock,lucky',3);
...
VALUES
    ...
    (15,'100003','107','PRIZE','lock','1','抽奖1次后解锁'),
    (16,'100003','108','PRIZE','lock','2','抽奖2次后解锁'),
    (17,'100003','109','PRIZE','lock','6','抽奖6次后解锁');
