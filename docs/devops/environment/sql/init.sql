...
VALUES
    (1,'100001','101','随机积分',NULL,80000,80000,80.0000,'random,lucky_prize',1),
    (2,'100001','102','5次使用',NULL,10000,10000,10.0000,'lucky_prize',2),
    (3,'100001','103','10次使用',NULL,5000,5000,5.0000,'lucky_prize',3),
    (4,'100001','104','20次使用',NULL,4000,4000,4.0000,'lucky_prize',4),
    (5,'100001','105','增加gpt-4对话模型',NULL,600,600,0.6000,'lucky_prize',5),
    (6,'100001','106','增加dall-e-2画图模型',NULL,200,200,0.2000,'lucky_prize',6),
    (7,'100001','107','增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.2000,'lock,lucky_prize',7),
    (8,'100001','108','100次使用','抽奖2次后解锁',199,199,0.1999,'lock,lucky_prize',8),
    (9,'100001','109','解锁全部模型','抽奖6次后解锁',1,1,0.0001,'lock,lucky_prize',9);
...
CREATE TABLE `raffle_strategy_rule` (
 ...
 `model` varchar(16) NOT NULL COMMENT '抽奖规则类型【random - 随机值计算、lock - 抽奖几次后解锁、lucky_prize - 幸运奖(兜底奖品)、weight - 权重、blacklist - 黑名单】',
 `value` varchar(64) NOT NULL COMMENT '抽奖规则比值',
...
VALUES
	(1,'100001','101','PRIZE','random','1,1000','随机积分策略'),
	(2,'100001','107','PRIZE','lock','1','抽奖1次后解锁'),
	(3,'100001','108','PRIZE','lock','2','抽奖2次后解锁'),
	(4,'100001','109','PRIZE','lock','6','抽奖6次后解锁'),
	(5,'100001','101','PRIZE','lucky_prize','1,10','兜底奖品10以内随机积分'),
	(6,'100001','102','PRIZE','lucky_prize','1,20','兜底奖品20以内随机积分'),
	(7,'100001','103','PRIZE','lucky_prize','1,30','兜底奖品30以内随机积分'),
	(8,'100001','104','PRIZE','lucky_prize','1,40','兜底奖品40以内随机积分'),
	(9,'100001','105','PRIZE','lucky_prize','1,50','兜底奖品50以内随机积分'),
	(10,'100001','106','PRIZE','lucky_prize','1,60','兜底奖品60以内随机积分'),
	(11,'100001','107','PRIZE','lucky_prize','1,100','兜底奖品100以内随机积分'),
	(12,'100001','108','PRIZE','lucky_prize','1,100','兜底奖品100以内随机积分'),
	(13,'100001',NULL,'STRATEGY','weight','6000,102,103,104,105,106,107,108,109,110','消耗6000分，必中奖范围'),
	(14,'100001',NULL,'STRATEGY','blacklist','1','黑名单抽奖，1积分兜底');
