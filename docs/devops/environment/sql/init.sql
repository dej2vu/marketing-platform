...
VALUES
    ...
    (10,'110','user_credit_blacklist','1','黑名单积分');
...
VALUES
    ...
    (5,'100001','105','增加gpt-4对话模型',NULL,600,600,0.6000,'lucky',5),
    (6,'100001','106','增加dall-e-2画图模型',NULL,200,200,0.2000,'lucky',6),
    (7,'100001','107','增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.2000,'lock,lucky',7),
    (8,'100001','108','100次使用','抽奖2次后解锁',199,199,0.1999,'lock,lucky',8),
    (9,'100001','109','解锁全部模型','抽奖6次后解锁',1,1,0.0001,'lock,lucky',9),
...
VALUES
	...
	(13,'100001',NULL,'STRATEGY','weight','4000:102,103,104,105 5000:102,103,104,105,106,107 6000:102,103,104,105,106,107,108,109','积分权重规则'),
